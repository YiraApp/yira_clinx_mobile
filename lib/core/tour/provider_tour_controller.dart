...
class ProviderTourController {
  ...
  final GlobalKey headerKey = GlobalKey(debugLabel: 'tour_header');
  final GlobalKey metricsKey = GlobalKey(debugLabel: 'tour_metrics');
  final GlobalKey scheduleKey = GlobalKey(debugLabel: 'tour_schedule');
  final GlobalKey chartsKey = GlobalKey(debugLabel: 'tour_charts');
  final GlobalKey profileKey = GlobalKey(debugLabel: 'tour_profile');

  final GlobalKey homeNavKey = GlobalKey(debugLabel: 'tour_nav_home');
  final GlobalKey apptsNavKey = GlobalKey(debugLabel: 'tour_nav_appts');
  final GlobalKey patientsNavKey = GlobalKey(debugLabel: 'tour_nav_patients');
  final GlobalKey slotsNavKey = GlobalKey(debugLabel: 'tour_nav_slots');

  final GlobalKey apptsFilterKey = GlobalKey(debugLabel: 'tour_appts_filter');
  final GlobalKey apptsListKey = GlobalKey(debugLabel: 'tour_appts_list');

  final GlobalKey patientsSearchKey = GlobalKey(debugLabel: 'tour_patients_search');
  final GlobalKey patientsListKey = GlobalKey(debugLabel: 'tour_patients_list');

  final GlobalKey slotsCalendarKey = GlobalKey(debugLabel: 'tour_slots_calendar');
  final GlobalKey slotsListKey = GlobalKey(debugLabel: 'tour_slots_list');
  final GlobalKey slotsFabKey = GlobalKey(debugLabel: 'tour_slots_fab');
  ...
  void _showCurrentStep(BuildContext context) {
    ...
    // Scroll into view if widget is mounted in a scrollable
  ...
  void _completeTour() {
    ...
    prefs.setValue(userCompletedKey, true);
    prefs.setValue(_kTourCompletedKey, true);
    prefs.setValue(userDontShowKey, true);
    prefs.setValue(_kTourDontShowAgainKey, true);
