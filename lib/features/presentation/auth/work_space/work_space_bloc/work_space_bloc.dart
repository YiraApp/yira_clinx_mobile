...
class WorkspaceBloc extends Bloc<WorkspaceEvent, WorkspaceState> {
  ...
  WorkspaceBloc({required this.getWorkSpaceDetailsUseCase}) : super(WorkspaceInitial()) {
  ...
  void _onLoadWorkspaces(LoadWorkspacesEvent event, Emitter<WorkspaceState> emit) async {
  ...
  void _onToggleOrganization(
    ...
    if (state is WorkspacesLoaded) {
      ...
      final updatedExpandedIds = Set<int>.from(currentState.expandedOrganizationIds);
