...
class UploadRecordFab extends StatefulWidget {
  final VoidCallback onDocumentUploaded;

  const UploadRecordFab({
    super.key,
    required this.onDocumentUploaded,
  });

  @override
  State<UploadRecordFab> createState() => _UploadRecordFabState();
}

class _UploadRecordFabState extends State<UploadRecordFab> with SingleTickerProviderStateMixin {
    ...
    return Column(
      ...
      children: [
        _buildChildOption(
          ...
          color: primaryColor,
          onTap: widget.onDocumentUploaded,
          offsetMultiplier: 1,
          isDark: isDark,
        ),
