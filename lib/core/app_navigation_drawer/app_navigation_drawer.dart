          ...
          child: BlocConsumer<NavigationDrawerBloc, NavigationDrawerState>(
            ...
            listener: (BuildContext context, NavigationDrawerState state) async {
              switch (state) {
                ...
                case LogoutNavState():
                  Navigator.pop(context);
                  await SignOutAlert.showSignCustomDialog(
                    context,
                    primaryColor,
                  );
                  break;
                          ...
                          ...List.generate(primaryNavItems.length, (index) {
                            ...
                            return CustomMenuTile(
                              ...
                              onTap: () {
                                ...
                                switch (index) {
                                  case 0:
                                    bloc.add(const DashBoardNav());
                                    break;
                                  case 1:
                                    bloc.add(OrgSwitchNav());
                                    break;
                                  case 2:
                                    bloc.add(const AppointmentsNav());
                                    break;
                                  case 3:
                                    bloc.add(const PatientsNav());
                                    break;
                                  case 4:
                                    bloc.add(const DoctorSlotsNav());
                                    break;
                                  case 5:
                                    bloc.add(const ReadAboutUsNavEvent());
                                    break;
                                  case 6:
                                    bloc.add(const ContactNavEvent());
                                    break;
                                  case 7:
                                    bloc.add(const PrivacyNavEvent());
                                    break;
                                }
                              },
                            );
