...
class AppointmentRecordFab extends StatefulWidget {
  final VoidCallback OnAppointmentBook;

  const AppointmentRecordFab({
    super.key,
    required this.OnAppointmentBook,
  });

  @override
  State<AppointmentRecordFab> createState() => _AppointmentRecordFabState();
}

class _AppointmentRecordFabState extends State<AppointmentRecordFab> with SingleTickerProviderStateMixin {
    ...
    return Column(
      ...
      children: [
        _buildChildOption(
          ...
          icon: Icons.event,
          color: primaryColor,
          onTap: widget.OnAppointmentBook,
          offsetMultiplier: 1,
          isDark: isDark,
        ),
